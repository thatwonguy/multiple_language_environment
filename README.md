...
>[!NOTE]
> The below readme is a simple method of starting from scratch, you will need to install both c#, java, and python in your environment properly and make sure all your environment variables are set up correctly to be able to work in all three environments and get them all working. The source code in this repo has additional layers of complexity in it as `maven` was used for java project management, and `poetry` was used for the python project and dependency management. Jave and C# is a compiled language and Python is a general purpose interpretted language. All three can be used together to get work done. This is a repo provides a basic demostration of that, which essentially means multiple people who are skilled at different programming languages can work together to get coding done and build something out. In this case, python ends up bringing it all together. There are three main code files used here, located in the `src`, `CSharpProgram`, and `JavaProgram` directories. They contain some additional comments not found in the readme below, in case you wanted to dig deeper, although, the below readme should be more than enough to get something working for you if you simply follow it troubleshoot your way through it.
